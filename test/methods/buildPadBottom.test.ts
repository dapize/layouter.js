...
describe('Buildings Padding-bottom', () => {
  ...
  it('With breakpoints', () => {
    expect(layouter.buildPadBottom('10 20.5@sm 30@md')).toEqual({
      ...
      'padb-20_5@sm':
        '@media screen and (min-width: 768px){.padb-20_5\\@sm{padding-bottom:20.5px}}',
      'padb-30@md':
        '@media screen and (min-width: 1024px){.padb-30\\@md{padding-bottom:30px}}',
    });
  });
  ...
  it('With breakpoints and important flag', () => {
    expect(layouter.buildPadBottom('10! 20.5@sm! 30@md')).toEqual({
      ...
      'padb-20_5@sm!':
        '@media screen and (min-width: 768px){.padb-20_5\\@sm\\!{padding-bottom:20.5px !important}}',
      'padb-30@md':
        '@media screen and (min-width: 1024px){.padb-30\\@md{padding-bottom:30px}}',
    });
  });
