...
describe('Buildings Paddings', () => {
  ...
  it('With breakpoints', () => {
    expect(layouter.buildPads('10-1/15 20.5-3/31@sm 30-2/31@md')).toEqual({
      ...
      "pad-20_5-3/31@sm": "@media screen and (min-width: 768px){.pad-20_5-3\\/31\\@sm{padding:20.5px 9.677%}}",
      "pad-30-2/31@md": "@media screen and (min-width: 1024px){.pad-30-2\\/31\\@md{padding:30px 6.452%}}"
    })
  });
  ...
  it('With breakpoints and important flag', () => {
    expect(layouter.buildPads('10-1/15! 20.5-3/31@sm! 30-2/31@md')).toEqual({
      ...
      "pad-20_5-3/31@sm!": "@media screen and (min-width: 768px){.pad-20_5-3\\/31\\@sm\\!{padding:20.5px 9.677% !important}}",
      "pad-30-2/31@md": "@media screen and (min-width: 1024px){.pad-30-2\\/31\\@md{padding:30px 6.452%}}"
    })
  });
});
