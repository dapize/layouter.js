...
import { IBuild } from '../../src/methods/build';
...
describe('Building all', () => {
  it('All Together', () => {
    ...
    const builded = buildResponse as Partial<IBuild>;
    ...
    expect(builded.mar).toEqual({
      'mar-0-0-20-0@sm':
        '@media screen and (min-width: 768px){.mar-0-0-20-0\\@sm{margin:0 0 20px 0}}',
      'mar-0-2/13-0-0@-sm':
        '@media screen and (max-width: 767px){.mar-0-2\\/13-0-0\\@-sm{margin:0 15.385% 0 0}}',
    });
    expect(builded.pad).toEqual({
      'pad-20-0@sm':
        '@media screen and (min-width: 768px){.pad-20-0\\@sm{padding:20px 0}}',
    });
  });
  ...
  it('Separated', () => {
    ...
    expect(layouter.build({ padt: '10 40.5@sm 30@md' })).toEqual({
      padt: {
        ...
        'padt-30@md':
          '@media screen and (min-width: 1024px){.padt-30\\@md{padding-top:30px}}',
        'padt-40_5@sm':
          '@media screen and (min-width: 768px){.padt-40_5\\@sm{padding-top:40.5px}}',
      },
    });
    expect(layouter.build({ padr: '20 50.5@sm 40@md' })).toEqual({
      padr: {
        ...
        'padr-40@md':
          '@media screen and (min-width: 1024px){.padr-40\\@md{padding-right:40px}}',
        'padr-50_5@sm':
          '@media screen and (min-width: 768px){.padr-50_5\\@sm{padding-right:50.5px}}',
      },
    });
    expect(layouter.build({ padb: '30 60.5@sm 50@md' })).toEqual({
      padb: {
        ...
        'padb-50@md':
          '@media screen and (min-width: 1024px){.padb-50\\@md{padding-bottom:50px}}',
        'padb-60_5@sm':
          '@media screen and (min-width: 768px){.padb-60_5\\@sm{padding-bottom:60.5px}}',
      },
    });
    expect(layouter.build({ padl: '40 70.5@sm 60@md' })).toEqual({
      padl: {
        'padl-60@md':
          '@media screen and (min-width: 1024px){.padl-60\\@md{padding-left:60px}}',
        'padl-70_5@sm':
          '@media screen and (min-width: 768px){.padl-70_5\\@sm{padding-left:70.5px}}',
    ...
    expect(layouter.build({ mart: '50 30.5@sm 70@md' })).toEqual({
      mart: {
        'mart-30_5@sm':
          '@media screen and (min-width: 768px){.mart-30_5\\@sm{margin-top:30.5px}}',
        'mart-50': '.mart-50{margin-top:50px}',
        'mart-70@md':
          '@media screen and (min-width: 1024px){.mart-70\\@md{margin-top:70px}}',
      },
    });
    expect(layouter.build({ marr: '60 20.5@sm 80@md' })).toEqual({
      marr: {
        ...
        'marr-80@md':
          '@media screen and (min-width: 1024px){.marr-80\\@md{margin-right:80px}}',
      },
    });
    expect(layouter.build({ marb: '70 40.5@sm 90@md' })).toEqual({
      marb: {
        'marb-40_5@sm':
          '@media screen and (min-width: 768px){.marb-40_5\\@sm{margin-bottom:40.5px}}',
        'marb-70': '.marb-70{margin-bottom:70px}',
        'marb-90@md':
          '@media screen and (min-width: 1024px){.marb-90\\@md{margin-bottom:90px}}',
      },
    });
    expect(layouter.build({ marl: '80 5.5@sm 100@md' })).toEqual({
      marl: {
        'marl-100@md':
          '@media screen and (min-width: 1024px){.marl-100\\@md{margin-left:100px}}',
        'marl-5_5@sm':
          '@media screen and (min-width: 768px){.marl-5_5\\@sm{margin-left:5.5px}}',
