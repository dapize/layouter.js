...
describe('Building Flex', () => {
  ...
  it('simple with important flag', () => {
    expect(layouter.buildFlex('jc:ce!')).toEqual({
      "flex-jc:ce!": ".flex-jc\\:ce\\!{justify-content:center !important;display:flex !important;}"
    });
  });
  ...
  it('With breakpoints and important flag', () => {
    expect(layouter.buildFlex('jc:ce! ai:ce fw:w@sm! jc:sb@sm fd:co@md!')).toEqual({
      "flex-fd:co@md!": "@media screen and (min-width: 1024px){.flex-fd\\:co\\@md\\!{flex-direction:column !important;display:flex !important;}}",
      "flex-fw:w-jc:sb@sm": "@media screen and (min-width: 768px){.flex-fw\\:w-jc\\:sb\\@sm{flex-wrap:wrap !important;justify-content:space-between;display:flex;}}",
      "flex-jc:ce!-ai:ce@xs": ".flex-jc\\:ce\\!-ai\\:ce\\@xs{justify-content:center !important;align-items:center;display:flex !important;}"
    })
  });
});
