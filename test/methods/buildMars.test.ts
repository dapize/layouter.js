...
describe('Buildings Margins', () => {
  ...
  it('With breakpoints', () => {
    expect(layouter.buildMars('10-1/15 20.5-3/31@sm 30-2/31@md')).toEqual({
      ...
      "mar-20_5-3/31@sm": "@media screen and (min-width: 768px){.mar-20_5-3\\/31\\@sm{margin:20.5px 9.677%}}",
      "mar-30-2/31@md": "@media screen and (min-width: 1024px){.mar-30-2\\/31\\@md{margin:30px 6.452%}}"
    })
  });
  ...
  it('With breakpoints and important flag', () => {
    expect(layouter.buildMars('10-1/15! 20.5-3/31@sm 30-2/31@md!')).toEqual({
      ...
      "mar-20_5-3/31@sm": "@media screen and (min-width: 768px){.mar-20_5-3\\/31\\@sm{margin:20.5px 9.677%}}",
      "mar-30-2/31@md!": "@media screen and (min-width: 1024px){.mar-30-2\\/31\\@md\\!{margin:30px 6.452% !important}}"
    })
  });
});
